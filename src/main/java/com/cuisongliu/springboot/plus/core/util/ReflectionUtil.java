package com.cuisongliu.springboot.plus.core.util;

import com.cuisongliu.springboot.plus.annotation.FieldType;
import com.cuisongliu.springboot.plus.annotation.ValidationNum;
import com.cuisongliu.springboot.plus.annotation.ValidationStr;
...
public class ReflectionUtil {
    ...
    public static String isValidation(Object object, String fieldName) {
        ...
        if (field == null) {
            ...
            com.cuisongliu.springboot.plus.annotation.Field f = field.getAnnotation(com.cuisongliu.springboot.plus.annotation.Field.class);
            if (f != null) {
